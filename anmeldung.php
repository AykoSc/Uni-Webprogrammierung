...
if (isset($_GET["Email"]) && is_string($_GET["Email"])
    && isset($_GET["Verifizierungscode"]) && is_string($_GET["Verifizierungscode"])) {
...
<main>
    <?php if (isset($anmeldung) && is_array($anmeldung) && $anmeldung[0] === -1): ?>
        <p class="nachricht fehler">Anmeldung fehlgeschlagen</p>
    <?php endif ?>
    <?php if (isset($_GET["registrieren"]) && $_GET["registrieren"] === "1"): ?>
